...
declare class RequirementsConverter {
    ...
    static setValue<C extends Container, V>(field: Field<C, V>, container: C, value: V): Promise<C>;
    static getValue<C extends Container, V>(field: Field<C, V>, container: C): Promise<V | null | undefined>;
