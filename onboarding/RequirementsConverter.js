...
class RequirementsConverter {
    ...
    convertRequirement(accountToken, requirementId) {
        ...
        const notEmptyEntityToken = entityName ? util_1.notEmpty(entityToken) : accountToken;
        return field
            ? new types_1.Requirement(requirementId, defaultedEntityName, field, notEmptyEntityToken)
            : new types_1.Requirement(requirementId, types_1.EntityType.UNKNOWN, Field_1.default.unknown(requirementId), notEmptyEntityToken);
    }
}
