...
class RequirementsConverter {
    ...
    static setValue(field, params, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return field.setValue(params, value);
        });
    }
    static getValue(field, params) {
    ...
    convertRequirement(accountToken, requirementId) {
        ...
        const potentialFields = potentialFieldIds.map((id) => __classPrivateFieldGet(this, _entityRegistry).lookupFieldOrBundle(defaultedEntityName, id));
